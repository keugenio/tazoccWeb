        ...
        <Accordion.Toggle as={Card.Title} eventKey="1" className="bg-sucess">              
          <Card.Title  className="bg-success text-white d-flex justify-content-start align-items-center m-0">
            ...
            <div className="ml-auto d-flex align-items-center">
              {(this.props.user.role == "admin" || this.props.user.role=="superAdmin" && this.props.location=="admin") && <Search location={this.props.location}/>}
              <EditProfile location={this.props.location} />
...
const MapStateToProps = ({selectedPaddler, user}) => ({
  selectedPaddler,user
})
